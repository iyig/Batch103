...
public class Queue01 {
  ...
  /*
  Ilk giren elemani ilk kullanmaniz(First In First Out==> FIFO) gerektiğinde Queue en iyi secimdir.
 Queue da elamanlar"insertion order" (giriş sirası) göre dizilirler
  Queue da peek(), element(),remove() gibi ilk elemani ilgilendiren bir cok method vardir.
  offer() method'u kapasite kontrolu yapıldıktan sonra eleman ekleme durumlarında kullanılır
   */
