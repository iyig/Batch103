...
public class DateTime01 {
    public static void main(String[] args) {
        //Example1: Tom, Ali'den 3 yıl 8 ay 13 gün sonra doğdu. Ali ise Veli'den 1 yıl 15 gün önce doğdu.
        //Tom un doğum tarihi 18 Kasım 2011 ise Veli ve Alinin doğum tarihlerini bulunuz
